...
<div class="card-body">
    <div class="input-states">
        <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
         ...
         <div class="form-group">
                <div class="row">
                    <label class="col-sm-2 control-label">Consumer Name</label>
                    <div class="col-sm-4">
...
-->                                               </div>
                    ...
                    <label class="col-sm-2 control-label">Consumer Contact No.</label>
                    <div class="col-sm-4">
...
<div class="form-group">
                <div class="row">
                    <label class="col-sm-2 control-label">Select Delivery Staff</label>
                    <div class="col-sm-4">
                       <select class="form-control select2" id="clientName" name="delivery_staff">
<option value="">~~SELECT~~</option>
<option value="Arjun Kale">Arjun Kale</option>
<option value="Avinash Wagh">Avinash Wagh</option>
<option value="Kishor Suryawanshi">Kishor Suryawanshi</option>
<option value="Akhil Kumar">Akhil Kumar</option>
                    ...
                    <div class="col-sm-4">
                       <select class="form-control select2" id="clientName" name="delivery_status">
<option value="">~~SELECT~~</option>
...
<button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-primary btn-flat m-b-30 m-t-30"><i class="glyphicon glyphicon-ok-sign"></i> Submit</button>
